...
## Importing Strava date for use with RStudio
...
Once you run that chunk, it will download your data into a dataframe called "*data_df.Rda*" which can be added to RStudio for your continued exploration.
